...
class PopUpViewController: UIViewController {
    ...
    func setupConstraints() {
        ...
        compactConstraints.append(instructionsLabelStackView.centerXAnchor.constraint(equalTo: view.centerXAnchor))
        compactConstraints.append(instructionsLabelStackView.centerYAnchor.constraint(equalTo: view.centerYAnchor))
        ...
        if largest < 600 {
            instructionsLabel1Horizontal.font = UIFont.systemFont(ofSize: 11)
            instructionsLabel2Horizontal.font = UIFont.systemFont(ofSize: 11)
            instructionsLabel3Horizontal.font = UIFont.systemFont(ofSize: 11)
            instructionsLabel4Horizontal.font = UIFont.systemFont(ofSize: 11)
            compactConstraints.append(contentsOf: [
                instructionsLabel1Horizontal.widthAnchor.constraint(equalToConstant: 140),
                instructionsLabel1Horizontal.heightAnchor.constraint(equalToConstant: 225),
                instructionsLabel2Horizontal.widthAnchor.constraint(equalToConstant: 120),
                instructionsLabel2Horizontal.heightAnchor.constraint(equalToConstant: 225),
                instructionsLabel3Horizontal.widthAnchor.constraint(equalToConstant: 130),
                instructionsLabel3Horizontal.heightAnchor.constraint(equalToConstant: 225),
                instructionsLabel4Horizontal.widthAnchor.constraint(equalToConstant: 150),
